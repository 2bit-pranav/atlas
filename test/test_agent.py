...
from ..agent.web_agent.agent import create_web_agent
from ..agent.file_agent.agent import create_file_agent
...
class AtlasAgent:
    ...
    def _build_agent(self) -> AssistantAgent:
        ...
        web_agent = create_web_agent(model_client=local_model)
        file_agent = create_file_agent(model_client=local_model)
